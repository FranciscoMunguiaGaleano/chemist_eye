...
class GUI():
    def __init__(self):
        self.root = tk.Tk()
        self.root.title('Camera one tf calibrator')
        ...
        while not rospy.is_shutdown():
            ...
            try:
                self.br.sendTransform((x, y, z),
                                      ...
                                      rospy.Time.now(),
                                      "camera_link",  # Change to the appropriate frame name
                                      "world")
            except:
                pass
            self.rate.sleep()
    ...
    def load_config(self):
        config_path = os.path.join(os.path.dirname(__file__), '../config/cameraone_tf_conf.yaml')

...
import time
from chemist_eye.srv import RunBashScript  # Import the service message type
...
class YOLOv8Node:
    def __init__(self):
        ...
        self.array_sub = rospy.Subscriber('camera/depth/array', Float32MultiArray, self.distance_callback)
        self.warning_colour_one_sub = rospy.Subscriber('cameraone/warning_color_topic', String, self.colour_callback)

        # Publisher for annotated images
        self.annotated_image_pub = rospy.Publisher('camera/annotated_image', Image, queue_size=10)
    ...
    def broadcast_tf(self, x, y, z, human_id):
        ...
        tf_msg.child_frame_id = f"humanone_{human_id}_frame"  # Unique frame for each person
    ...
    def update_markers(self, x, y, z, human_id):
        ...
        cylinder_marker.header.frame_id = f"humanone_{human_id}_frame"
        ...
        sphere_marker.header.frame_id = f"humanone_{human_id}_frame"
        ...
        shoulder_marker.header.frame_id = f"humanone_{human_id}_frame"

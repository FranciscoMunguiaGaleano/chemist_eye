...
BASH_SCRIPT_PATH = '/home/francisco/catkin_ws/src/chemist_eye/scripts_vision/chemisteye_three_fire_warning.bash'
...
def bash_script_service():
    ...
    """
    rospy.init_node('fire_warning_speech_service_three')
    service = rospy.Service('run_fire_warning_service_three', RunBashScript, run_bash_script)
    rospy.loginfo("Fire warning service three is ready.")
    rospy.spin()
